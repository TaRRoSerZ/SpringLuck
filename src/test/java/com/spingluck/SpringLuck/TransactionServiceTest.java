...
public class TransactionServiceTest {
    ...
    void getAllTransactions() {
        ...
        Transaction t1 = new Transaction(1, 500.0, bet1, TransactionType.DEPOSIT, new Date());
        Transaction t2 = new Transaction(2, 200.0, bet2, TransactionType.WITHDRAWAL, new Date());
    ...
    void getTransactionById() {
        ...
        Assertions.assertEquals(transaction.get().getBet().getId(), t1.getBet().getId());
    }
